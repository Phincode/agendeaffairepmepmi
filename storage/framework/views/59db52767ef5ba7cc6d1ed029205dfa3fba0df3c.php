...
<br>
 <h1 style="text-align: center" >Retour Favorable Partenaire Financier</h1>
<br>
<div class="row staff-grid-row" style="padding-left:10px; ">
    ...
    <div class="col-md-6 col-sm-6 col-12 col-lg-6 col-xl-3">
        <div class="profile-widget">
            ...
            <div class="small text-muted">Observation: <?php echo e(explode('/',$Pme->Observation,)[0]); ?> </div>
            <div class="small text-muted">Partenaire: <?php echo e(explode('/',$Pme->Observation,)[1]); ?> </div>
            
            <div class="small text-muted">Analyste:<?php echo e($Pme->name); ?> </div>
            <hr>
            <div class="small text-muted">Nom propiétaire:<?php echo e($Pme->nomProprietaire); ?> </div>
            <div class="small text-muted">Numéro propiétaire:<?php echo e($Pme->numeroProprietaire); ?> </div>
            <div class="small text-muted">Mail propiétaire:<?php echo e($Pme->emailProprietaire); ?> </div>
            <hr>
            ...
            <form action="" method="post">
                <div class="submit-section">
                    <Button type="submit" class="btn btn-primary" >Autoriser pour coaching</Button>
                </div>
            </form>
...
<?php echo $__env->make('layout.dashboard.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/Ampps/www/agendeaffairepmepmi/resources/views/dashboard/retourBanque.blade.php ENDPATH**/ ?>