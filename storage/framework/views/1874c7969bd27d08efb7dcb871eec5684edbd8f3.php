        ...
        <div class=" content cover text-center align-content-around ">
            ...
            <div  class="row">
                    <div class=" option  col-sm-12 offset-lg-1 col-lg-3 col-md-3">
                        <div class="col-lg-12">
                            <br><br>
                            <a data-toggle="modal" data-target="#add_leave"  role="button"><img class="rounded-circle" src="<?php echo e(asset('home/img/menuoption/brainstormingsouscription.png')); ?> " alt="Generic placeholder image" width="200" height="200"></a>
                ...
                <div  class=" option col-sm-12 col-lg-3 col-md-3 align-items-center">
                    <div class="col-lg-12">
                        <br><br>
                        <a  href="<?php echo e(route('souscriptionDossier')); ?> " role="button"><img class="rounded-circle" src="<?php echo e(asset('home/img/menuoption/dossier.png')); ?> " alt="Generic placeholder image" width="200" height="200">
