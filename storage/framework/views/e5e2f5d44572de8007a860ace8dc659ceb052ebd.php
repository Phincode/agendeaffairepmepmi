    ...
    <div class="container-fluid">
        <div class=" content cover text-center">
            ...
            <br class="d-none d-lg-block d-xl-block">
                ...
                <strong>Désolé:</strong>  <?php echo e(session()->get('error')); ?>
            ...
            <div class="row align-items-center ">
                ...
                <div class=" offset-xl-3 option col-sm-12 col-lg-3 col-md-3 align-items-center">
                    <div class="col-lg-12">
                        ...
                        <a data-toggle="modal" data-target="#add_dossier"  href="#" role="button">
                            <img class="rounded-circle" src="<?php echo e(asset('home/img/menuoption/depotdossier.png')); ?> " alt="Generic placeholder image" width="200" height="200">
                        </a>
                ...
                <div  class="option  col-sm-12 col-lg-3 col-md-3 align-items-center">
                    <div class="col-lg-12">
                        ...
                        <br>
                        <a  href="#" role="button">
                            <img class="rounded-circle" src="<?php echo e(asset('home/img/menuoption/dossierplateforme.png')); ?> " alt="Generic placeholder image" width="200" height="200">
                        </a>
