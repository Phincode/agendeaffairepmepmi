	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" method="POST" action="<?php echo e(route('connecte')); ?> " >
					<?php echo csrf_field(); ?>
...
</html><?php /**PATH /Applications/Ampps/www/agendeaffairepmepmi/resources/views/connexion/index.blade.php ENDPATH**/ ?>