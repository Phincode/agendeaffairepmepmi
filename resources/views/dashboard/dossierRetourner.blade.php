                ...
                <div class="file-sidebar">
                    ...
                    <div class="file-pro-list">
                        <div class="file-scroll">
                            <ul class="file-menu">
                                @foreach ($listDossier as $item)
                                <li>
                                    <a href="{{route('dossierGeneral',['iddossier'=>$item->id])}} ">{{$item->nom}}</a>
                                </li>
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-4 col-xl-3">
                                                <div class="card card-file">
                                                    ...
                                                    <div class="card-body">
                                                        <h6><a href="{{url($files->pathFichier)}} ">{{$files->nomFichier}} </a></h6>
                                                        <span>...</span>
                                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('transfertDossierGeneral')}}">
                    @csrf
                    <div class="form-group">
                        <label>Laissez une observation <span class="text-danger">*</span></label>
                        <input type="text"  name="observations"   class="form-control">
                    </div>
                    <input type="hidden"  name="idDossier" value="{{$currentDossier}} " class="form-control">
