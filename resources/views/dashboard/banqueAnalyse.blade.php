                        ...
                        <div class="file-scroll">
                            <ul class="file-menu">
                                @foreach ($listPmetoScore as $item)
                                   <li>
                                      <a href="{{route('dashboardBank',['iddossier'=>$item->id])}} ">{{$item->nom}}</a>
                                      <div class="">
                    ...
                    <div class="file-cont-inner">
                        ...
                        <div class="file-content">
                            ...
                            <div class="" style="padding-left: 10px;">
                                @if (Auth::user()->hasrole('Banque')||Auth::user()->hasrole('RAN') )
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{route('transfertDossierAnalyste')}}">
                    ...
                    <input type="hidden"  name="partenaireId" value="{{Auth::user()->id}} "   class="form-control">
