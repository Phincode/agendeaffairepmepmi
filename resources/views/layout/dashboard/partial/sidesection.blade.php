        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="menu-title"> 
                 ...
                 @if (Auth::user()->hasrole('AG')|| Auth::user()->hasrole('AAD') )
                 <li class="submenu">
                ...
                {{-- <li class="submenu">
                 ...
                 @if (Auth::user()->hasrole('AAD')||Auth::user()->hasrole('AG')||Auth::user()->hasrole('RAN')||Auth::user()->hasrole('AS'))
                 <li class="menu-title"> 
                    <span>Analystes</span>
                </li>
                @if (Auth::user()->hasrole('AAD') || Auth::user()->hasrole('AG')|| Auth::user()->hasrole('RAN'))
                <li class="submenu">
                ...
                @endif
                @if (Auth::user()->hasrole('AAD')|| Auth::user()->hasrole('AG'))
                <li class="submenu">
